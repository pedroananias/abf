...
declare -a DAYS_IN_OUT=("--days_in=1 --days_out=5" "--days_in=5 --days_out=5" "--days_in=10 --days_out=5")
...
declare -a RS_ITERS=("--rs_iter=25" "--rs_iter=50" "--rs_iter=100" "--rs_iter=250" "--rs_iter=500")
